...
class VideoHungarianMatcher(nn.Module):
    ...
    def memory_efficient_forward(self, outputs, targets):
        ...
        for b in range(bs):
            ...
            out_mask = outputs["pred_masks"][b]  # [num_queries, T, H_pred, W_pred], e.g., 100, 1, 120, 216
            # gt masks are already padded when preparing target
            tgt_mask = targets[b]["masks"].to(out_mask)  # [num_gts, T, H_real, W_real], e.g., 2, 1, 480, 864
...
class VideoHungarianTrackingMatcher(VideoHungarianMatcher):
    """
