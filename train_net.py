...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if dn.startswith("ytvis_2019") or dn.startswith("ytvis_2021") or dn.startswith("uvo") or dn.startswith("ovis") or dn.startswith("lvvis") or dn.startswith("burst_ytvis"):
            evaluator = YTVISEvaluator(dataset_name, cfg, True, output_folder)
        elif dn.startswith("burst"):
            evaluator = BURSTEvaluator(dataset_name, cfg, True, output_folder)
