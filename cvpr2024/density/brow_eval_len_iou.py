...
if __name__ == "__main__":
    ...
    if choice == 'burst':
        ...
        pred_json_file = "./work_dirs/openvoc_lvvis/brownian_online_R50_bs8_12000st_burst/eval/inference/results.json"
        ...
        lens_dst_path = 'cvpr2024/density/burst_mean_brow_lens.npy'
        ious_dst_path = 'cvpr2024/density/burst_mean_brow_ious.npy'
        ...
        pred_json_file = "./work_dirs/openvoc_lvvis/brownian_online_R50_bs8_12000st_ytvis19_train/eval/inference/results.json"
        gt_json_file = 'datasets/ytvis_2019/train.json'

        # json_file = os.path.join('.tmp', 'ytvis19_train_brow_pseudo_gt.json')
    ...
    for pd, gt in zip(pred_dicts, gt_dicts):
        ...
        if len(pd_track_ids) == 0 or len(gt_track_ids) == 0:
            continue
        ...
        print(len(len_list), len(iou_list))

        print(ious.mean(axis=0), gt_lengths)

        print(counts[str(gt_track_ids[0])])
        ...
        # print(ious.max(axis=0), gt_lengths, _gt_cat_ids)
