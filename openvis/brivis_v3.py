...
from .modeling.resampler import DecoupledTemporalInstanceResampler
...
class BriVISV3(SANOnline):
    ...
    def __init__(self, max_iter_num, **kwargs):
        ...
        self.resampler = DecoupledTemporalInstanceResampler(hidden_dim=256, feed_dim=2048, nheads=8, nlayers=6)
