...
# Modified by Zesen Cheng from https://github.com/facebookresearch/Mask2Former/blob/main/mask2former_video/data_video/build.py
import random
import itertools
import logging
...
class CombinedDataLoader:
    ...
    def __init__(self, loaders: Collection[Iterable[Any]], batch_size: int, ratios: Sequence[float]):
