...
@TRANSFORMER_DECODER_REGISTRY.register()
class EmbeddingVideoMultiScaleMaskedTransformerDecoder(VideoMultiScaleMaskedTransformerDecoder):
...
@TRANSFORMER_DECODER_REGISTRY.register()
class ProposalVideoMultiScaleMaskedTransformerDecoder(VideoMultiScaleMaskedTransformerDecoder):
