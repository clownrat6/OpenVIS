...
from trackeval.datasets.burst_helpers.format_converter import GroundTruthBURSTFormatToTAOFormatConverter, PredictionBURSTFormatToTAOFormatConverter


class BURSTSingle(_BaseDataset):
    ...
    def get_default_dataset_config(self):
        return BURST.get_default_dataset_config()
    ...
    def __init__(self, config=None):
        ...
        gt_dir_file = self.gt_fol

        with open(gt_dir_file, 'r') as f:
        ...
        if self.config['CLASSES_TO_EVAL']:
            ...
            if not all(self.class_list):
                raise utils.TrackEvalException('Attempted to evaluate an invalid class. Only classes ' +
        ...
        # hardcode for single tracker eval
        self.tracker_list = ['tracker1']

        self.tracker_to_disp = dict(zip(self.tracker_list, self.tracker_list))

        self.tracker_data = {'tracker1': {}}
        tr_dir_file = self.tracker_fol
        with open(tr_dir_file, 'r') as f:
        ...
        self.tracker_data['tracker1']['vids_to_tracks'] = curr_videos_to_tracker_tracks
        self.tracker_data['tracker1']['vids_to_images'] = curr_videos_to_tracker_images
    ...
    def _load_raw_file(self, tracker, seq, is_gt):
        ...
        if is_gt:
            ...
            all_tracks = self.tracker_data['tracker1']['vids_to_tracks'][seq_id]
    ...
    def _make_track_ids_unique(self, annotations):
        return BURST._make_track_ids_unique(annotations)
